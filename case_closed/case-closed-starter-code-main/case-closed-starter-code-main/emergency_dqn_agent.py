...
class EmergencyPathfindingAgent:
    ...
    def save_model(self, path=None):
        """Save model with optional custom path"""
        if path is None:
            path = r"C:\Users\Phillip\Desktop\coding projects\TamuDataton2025\Datathon2025\case_closed\case-closed-starter-code-main\case-closed-starter-code-main\emergency_dqn_model.pth"
        ...
        print(f"Emergency DQN Model saved to {path} (epsilon: {self.epsilon:.3f})")
    def load_model(self):
        try:
